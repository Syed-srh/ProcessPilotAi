            ...
            <div className="flex items-center justify-between border-b border-[#30363D] pb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`px-3 py-1 rounded text-xs font-mono transition-all ${activeTab === 'sop'
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded text-xs font-mono transition-all ${activeTab === 'graph'
                      ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 font-bold'
                      : 'text-slate-400 hover:text-slate-200'
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded text-xs font-mono transition-all ${activeTab === 'rag'
                      ? 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 font-bold'
                      : 'text-slate-400 hover:text-slate-200'
                    }`}
                >
...
Ground decision against active Company Refund Policy document.`}
        ...
        <footer className="mt-auto border-t border-[#30363D] bg-[#161B22] px-8 py-10">
          ...
          <div className="max-w-6xl mx-auto border-t border-[#30363D]/60 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between text-[11px] font-mono text-slate-500">
            ...
            <span className="text-emerald-400">System Operational • v1.0 Production MVP</span>
          </div>
        </footer>
      </div>
    </>
